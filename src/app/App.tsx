...
function Nav() {
  ...
  const links = ["Home", "About", "Skills", "Experience", "Certificates", "Projects", "Contact"];
  ...
  return (
    ...
    >
      <span className="font-mono text-lg font-bold shrink-0" style={{ color: t.primary, fontFamily: "Space Mono, monospace" }}>TA.</span>
          ...
          return (
            <li key={l}>
              <button
                ...
                style={{
                  color: isActive ? t.primary : t.fgMuted,
      ...
      {open && (
        <div
          className="absolute top-full left-0 right-0 flex flex-col gap-1 px-4 py-4"
          ...
          {links.map((l) => {
            ...
            return (
              <button
                key={l}
                onClick={() => scroll(l)}
                className="text-left text-sm font-medium px-4 py-3 rounded-xl transition-all"
                style={{
                  color: isActive ? t.primary : t.fgSub,
...
function ExperienceSection() {
  ...
  return (
    <section id="experience" className="relative z-10 py-16 md:py-24 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        <p className="text-xs font-mono tracking-widest uppercase mb-2" style={{ color: t.primary, fontFamily: "Space Mono, monospace" }}>
          MY JOURNEY
        </p>
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 md:mb-12" style={{ fontFamily: "Space Grotesk, sans-serif", color: t.fg }}>
          Experience
        </h2>
...
export default function App() {
  ...
  return (
    <ThemeCtx.Provider value={{ t, isDark, toggle }}>
      <div className="min-h-screen relative" style={{ background: t.bg, transition: "background 0.4s", fontFamily: "Poppins, sans-serif", overflowX: "hidden", width: "100%" }}>
        <StarField t={t} isDark={isDark} />

        {/* Ambient orbs — kept inside viewport via overflow-x hidden on parent */}
        <Orb className="w-72 h-72 top-10 left-0 opacity-20" bg={t.orbColor1} />
        <Orb className="w-64 h-64 top-40 right-0 opacity-15" bg={t.orbColor2} />
        <Orb className="w-56 h-56 top-[60%] left-1/3 opacity-10" bg={t.orbColor3} />

        <Nav />

        {/* ─── HERO ─── */}
        <section id="home" className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 pt-24 pb-16">
          <div className="max-w-5xl w-full mx-auto flex flex-col items-center gap-8 md:gap-12">
            {/* Photo */}
            <div className="flex justify-center">
              <div className="relative">
                ...
                <div className="relative w-56 h-56 md:w-72 md:h-72 rounded-full overflow-hidden"
                  ...
                  <ImageWithFallback src={profilePhoto} alt="Tessalonika Angeline Purba" className="w-full h-full object-cover object-[center_30%]" />
                </div>
            ...
            <div className="flex flex-col gap-4 md:gap-5 text-center max-w-3xl w-full px-2">
              <p className="text-xs font-mono tracking-widest uppercase" style={{ color: t.primary, fontFamily: "Space Mono, monospace" }}>
                ✦ Hello, World!
              </p>

              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight" style={{ fontFamily: "Space Grotesk, sans-serif", color: t.fg }}>
                Hi, I&apos;m<br />
              ...
              <p className="text-lg sm:text-xl md:text-2xl font-semibold tracking-wide" style={{ color: t.fgSub, fontFamily: "Space Grotesk, sans-serif" }}>
                Code.{" "}
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 mt-1 justify-center">
                ...
                <SocialButton href="https://www.instagram.com/angelaaaax__/" icon={<Instagram size={16} />} label="Instagram" color={t.purple} />
        ...
        {/* ─── ABOUT ─── */}
        <section id="about" className="relative z-10 py-16 md:py-24 px-4 sm:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 md:mb-12" style={{ fontFamily: "Space Grotesk, sans-serif", color: t.fg }}>About Me</h2>
        ...
        {/* ─── SKILLS ─── */}
        <section id="skills" className="relative z-10 py-16 md:py-24 px-4 sm:px-6">
          <div className="max-w-5xl mx-auto">
            <p className="text-xs font-mono tracking-widest uppercase mb-2" style={{ color: t.primary, fontFamily: "Space Mono, monospace" }}>WHAT I KNOW</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 md:mb-12" style={{ fontFamily: "Space Grotesk, sans-serif", color: t.fg }}>Skills</h2>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
              {([
                { title: "Programming Languages", icon: "💻", color: t.primary, items: ["HTML5","CSS3","JavaScript","TypeScript","Python","C++","Java","PHP","SQL","Bash"] },
                { title: "Frontend", icon: "🎨", color: t.accent, items: ["React","Vite","Tailwind CSS","Framer Motion","Responsive Web Design","EmailJS"] },
                { title: "Backend", icon: "⚙️", color: t.purple, items: ["Node.js","Express.js","REST API","Authentication","CRUD Operations"] },
                { title: "Database", icon: "🗄️", color: t.blue, items: ["PostgreSQL","MySQL","SQLite"] },
                { title: "AI & Computer Vision", icon: "🤖", color: "#f472b6", items: ["OpenCV","face_recognition","Face Detection","Face Recognition","Image Processing"] },
                { title: "Cyber Security", icon: "🔒", color: "#f59e0b", items: ["Kali Linux","Ubuntu","Autopsy","Wireshark","Nmap","Burp Suite","OWASP Juice Shop","Kleopatra (OpenPGP)","PuTTY"] },
                { title: "Operating Systems", icon: "🖥️", color: "#34d399", items: ["Windows","Ubuntu","Kali Linux"] },
                { title: "Tools", icon: "🛠️", color: "#a78bfa", items: ["Git","GitHub","VS Code","Postman","Docker","Figma","npm","Vercel","Android Studio"] },
              ] as { title: string; icon: string; color: string; items: string[] }[]).map(({ title, icon, color, items }) => (
                <GlassCard key={title} className="group cursor-default">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center text-xl shrink-0"
                      style={{ background: `${color}18`, border: `1px solid ${color}30` }}>
                      {icon}
                    </div>
                    <h3 className="text-base font-semibold" style={{ color: t.fg, fontFamily: "Space Grotesk, sans-serif" }}>{title}</h3>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {items.map((skill) => (
                      <span key={skill}
                        className="text-xs px-3 py-1.5 rounded-full font-mono transition-all duration-300 hover:scale-105 cursor-default"
                        style={{ background: `${color}12`, color, border: `1px solid ${color}22`, fontFamily: "Space Mono, monospace" }}>
                        {skill}
                      </span>
                    ))}
                  </div>
        ...
        {/* ─── CERTIFICATES ─── */}
        <section id="certificates" className="relative z-10 py-16 md:py-24 px-4 sm:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 md:mb-12" style={{ fontFamily: "Space Grotesk, sans-serif", color: t.fg }}>Certificates</h2>
                ...
                <div className="p-6 flex flex-col gap-4">
                  <div>
                    ...
                    <p className="text-sm leading-relaxed" style={{ color: t.fgMuted }}>
                      An automated attendance system using real-time face recognition — detects and identifies registered faces via webcam, logs attendance with timestamps automatically.
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {["Python", "OpenCV", "face_recognition", "Image Processing"].map(tag => (
      ...
      <Github size={16} /> View on GitHub
        ...
        <section id="contact" className="relative z-10 py-16 md:py-24 px-4 sm:px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 md:mb-4" style={{ fontFamily: "Space Grotesk, sans-serif", color: t.fg }}>Contact Me</h2>
            <p className="text-base mb-8 md:mb-12" style={{ color: t.fgMuted }}>Have a project in mind or just want to say hi? My inbox is always open.</p>
              ...
              <div className="md:col-span-2 flex flex-col gap-4 md:gap-5">
                ...
                <div className="flex flex-col gap-3 mt-2">
                  ...
                  <div className="flex flex-row flex-wrap gap-2 md:flex-col">
                    ...
                    <SocialButton href="https://www.instagram.com/angelaaaax__/" icon={<Instagram size={15} />} label="Instagram" color={t.purple} />
              ...
              <div className="md:col-span-3">
                <GlassCard>
                  <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    {/* CAPTCHA */}
                    <div className="rounded-xl p-4 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 w-full"
                      style={{ background: t.inputBg, border: `1px solid ${captchaError ? "#f87171" : t.inputBorder}`, transition: "border-color 0.2s" }}>
                      <div className="flex items-center gap-3 w-full sm:flex-1 min-w-0">
                        <span className="text-xs font-mono uppercase tracking-wider shrink-0" style={{ color: t.fgMuted, fontFamily: "Space Mono, monospace" }}>
                          Verify:
                        </span>
                        <span className="text-sm font-semibold px-3 py-1 rounded-lg shrink-0"
                          style={{ background: `${t.primary}15`, color: t.fg, border: `1px solid ${t.primary}25`, fontFamily: "Space Mono, monospace" }}>
                          {captcha.a} + {captcha.b} = ?
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          style={{ background: t.cardBg, border: `1px solid ${captchaError ? "#f87171" : t.inputBorder}`, color: t.fg, fontFamily: "Space Mono, monospace" }}
                        />
                        {captchaError && (
                          <span className="text-xs font-mono" style={{ color: "#f87171", fontFamily: "Space Mono, monospace" }}>Wrong!</span>
                        )}
                      </div>
                    </div>
